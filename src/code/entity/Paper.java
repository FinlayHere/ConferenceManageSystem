...
public class Paper implements TransferToCsvLine, EntityPrinter {
		...
		public Paper(Integer id, Integer authorId, Integer conferenceId, String topic, String name,
				LocalDate submitTime, String format, String state) {
				this.id = id;
		...
		public String getEntityLine() {
				return String.format(
						"id : %d, authorId : %d, conferenceId : %d, name : %s, topic : %s, submitDate : %s," +
