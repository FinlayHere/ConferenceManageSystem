...
public class ConferenceManageSystem {
		...
		private static final List<String> AVAILABLE_ROLES = Arrays
				.asList("author", "chair", "reviewer");
						...
						while (null == user) {
								try {
										...
										if (userOption == 2) {
												...
												user = conferenceManageSystem
														.register(email, password, confirmedPassword, role);
										}
								} catch (Exception e) {
										e.printStackTrace();
								}
